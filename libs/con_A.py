...
class CON_A:
    ...
    def move(self):
        ...
        time.sleep(0.3)
        for left in range(450,280,-1):  #왼족 모터. 아래로 내려감
        ...
        for left in range(230,450,1):  #천천히 들어올려 떨어지면 안 되니까
            ...
            time.sleep(0.001)
        time.sleep(0.7)
        for bottom in range(210,630,1):  #천천히 컨테이너 B로 움직여. 떨어지면 안 되니까
            pwm.set_pwm(12,0,bottom)
            time.sleep(0.001)
        time.sleep(0.7)
        pwm.set_pwm(8,0,400)
        pwm.set_pwm(15,0,420)
        time.sleep(0.7)
        pwm.set_pwm(9,0,350)  
        time.sleep(1)
...
#        pwm.set_pwm_freq(60)
        ...
        #pwm.set_pwm(1,0,300)  #1번구역 분류판 움직이기 
        #time.sleep(3)
        #pwm.set_pwm(1,0,130)  #분류판 제자리로
        #time.sleep(1)
    ...
    def jidong(self):
        ...
        self.move()
        #time.sleep(2)
        #pwm.set_pwm(2,0,300)  #2번구역 분류판 움직이기 
        #time.sleep(4)
        #pwm.set_pwm(2,0,130)  #분류판 제자리로
        #time.sleep(1)
